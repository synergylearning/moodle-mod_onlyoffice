...
class document_unlocked extends base {
    /**
     ...
     * @return string Description of the event (What happened)
     * @throws coding_exception
     */
    public function get_description(): string {
        ...
        return get_string('eventdocumentunlockeddesc', 'mod_onlyoffice', $a);
    }
    ...
    public static function get_name(): string {
        return get_string('eventdocumentunlocked', 'mod_onlyoffice');
    }

    /**
     * Get URL related to the action
     * @return moodle_url URL for this event to give further context
